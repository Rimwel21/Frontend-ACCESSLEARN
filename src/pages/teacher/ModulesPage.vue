    ...
    <div class="flex items-end justify-between">
      <div>
        <nav class="flex items-center gap-1.5 text-xs font-mono mb-1">
          ...
          <span class="text-ink font-semibold">Modules</span>
        </nav>
        <h2 class="font-display text-2xl font-bold">📖 Learning Materials</h2>
      </div>
      <button class="btn-primary">➕ Create Module</button>
    </div>
      ...
      <table class="w-full border-collapse">
        ...
        <tbody>
          <tr v-for="m in filteredModules" :key="m.id" class="hover:bg-gray-50 transition-colors">
            ...
            <td class="table-td">
              <div class="flex gap-2">
                <button class="text-xs px-3 py-1.5 rounded-lg border border-gray-200 hover:border-brand-blue hover:text-brand-blue transition-all">✏️ Edit</button>
